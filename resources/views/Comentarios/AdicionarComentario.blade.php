...
<html lang="en">
    ...
    <body>
        <header>
            <div class="border border-3 border-light p-3 text-center">
                <h1>Adicionar Comentarios</h1>
            </div>
        </header>
        <main>
            <div style="margin-top:8%;" class="container text-center">
                <form action="{{route("AdicionandoComentario",["id" => $id ])}}" class="p-2" method="post">
                    @csrf
                    <div class="mb-3">
                        <label for="Comentario" class="form-label">Comentario</label>
                        <textarea class="form-control" name="comentario_comentario" id="Comentario" rows="3"></textarea>
                    </div>
