...
<body>
    <header>
        <div id="menu" class="container-fluid p-3 border border-3 border-light ">
            <div class="row">
                ...
                <div class="col-4 text-center mt-3 ">
                    ...
                    <a id="btn-voltar" href="{{route('loginForm')}}" > Login </a>
    ...
    <div class="formulario" >
        <form action="{{route('tratarCadastro')}}" method="post">
            @csrf
            ...
            <input type="email" name="email_usuario" id="email_usuario" placeholder="Exemplo:Denji@gmail.com" > <br>
            <label for="email_usuario">Senha :</label> <br>
            <input type="password" name="senha_usuario" id="senha_usuario" placeholder="XXXXXXXXXXXX" > <br>
            <label for="cpf_usuario">CPF :</label> <br>
            <input type="text" name="cpf_usuario" id="cpf_usuario" placeholder="XXXXXXXXXXX" > <br>
            <label for="sexo_usuario">Data de nascimento :</label> <br>
            <input type="date" name="data_nasc_usuario" id="data_nasc_usuario" placeholder="01/01/2000" > <br>
